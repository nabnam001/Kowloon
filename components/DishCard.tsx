...
export function DishCard({
  ...
  return (
    <motion.button
      ...
      className="group relative flex flex-col overflow-hidden rounded-2xl border border-cream/10 bg-ink-800/60 text-left transition-colors duration-300 hover:border-cream/25 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gold focus-visible:ring-offset-2 focus-visible:ring-offset-ink"
    >
      <div className="relative aspect-[4/3] overflow-hidden bg-gradient-to-br from-ink-700 to-ink">
        {dish.hasImage ? (
          <Image
            ...
            className="object-contain p-3 drop-shadow-[0_10px_18px_rgba(0,0,0,0.5)] transition-transform duration-500 ease-out group-hover:scale-105"
          />
        ) : (
